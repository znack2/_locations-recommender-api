    ...
    try {
      ...
      const getLocationData = async location => {
        ...
        if(locationData[0] != null){
            ...
            //       // search.google(query, function(images){
            //         // callback({
            ...
            return Object.assign(locationData[0], {
              photo: posts.map(post => post != null ? post.display_url : null),
              mainphoto: data.[locationData[0].name].mainphoto,
              description: data.[locationData[0].name].description
